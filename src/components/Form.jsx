    ...
    return (
        <>
            <div className="header d-flex justify-content-end">
                <Link id="listBtn" className="btns btn" to="/view">View Record</Link>
            </div>
            <div className="container">
                <div className="row justify-content-center align-items-center">
                    <div className="card form-container">
                        <div className="card-body px-4">
                            <h3 className="mb-4 pb-2 pb-md-0 mb-md-5 text-center text-light">Add User Record</h3>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <div className="mb-4 form-floating">
                                            ...
                                            <div className="formerror" id="nameError">{error.password}</div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="mb-4">
